            ...
            <div class="container-fluid p-0 ">
                ...
                <div class="row ">
                    <div class="white_card card_height_100  mb_20">
                        ...
                        <h3 class ="mt_3 mb_5" style = "margin-top: 10px; margin-bottom: 10px; color:black">Add Users</h3>
                        <form action="function.php" method="post">
                            ...
                            <button type="submit" name="add-categories" class="btn btn-primary">Add User</button>
                        </form>
                    </div>
                </div>
            </div>
