            ...
            <div class="container-fluid p-0 ">
                    ...
                    <div class="col-12">
                        <div class="page_title_box d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <a href="users.php" class="white_btn3">User</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row ">
                    <div class="white_card card_height_100  mb_20">
                        ...
                        <h3 class ="mt_3 mb_5" style = "margin-top: 10px; margin-bottom: 10px; color:black">Edit Users</h3>

                        <form action="function.php" method="post">
                            <div class="row mb-3">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="inputEmail4">categoire Name</label>
                                    <input type="text" name="cat-name" class="form-control" id="inputEmail4" placeholder="Categorie Name">
                                </div>
                                <div class=" col-md-6 mb-3">
                                    <label class="form-label" for="inputPassword4">Meta Title</label>
                                    <input type="text" name="meta-title" class="form-control" id="inputPassword4" placeholder="Meta Title">
                                </div>
                                <div class=" col-md-6 mb-3">
                                    <label class="form-label" for="inputPassword4">Meta Keyword</label>
                                    <input type="text" class="form-control" name="meta-keyword" id="inputPassword4" placeholder="Meta Keyword">
                                </div>
                                <div class=" col-md-6 mb-3">
                                    <label class="form-label" for="inputPassword4">Meta Description</label>
                                    <input type="text" name="meta-desc" class="form-control" id="inputPassword4" placeholder="Meta Description">
                                </div>
                            </div>
                            ...
                            <button type="submit" name="add-categories" class="btn btn-primary">Edit User</button>
                        </form>
                    </div>
                </div>
            </div>
